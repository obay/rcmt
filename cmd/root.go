...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.rcmt.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".rcmt" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".rcmt")
	}
